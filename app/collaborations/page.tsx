  ...
  return (
    <main>
      ...
      <section className="mt-10 px-5">
        <div className="rounded-carte bg-vert p-6 text-papier shadow-douce">
      ...
      <section className="mt-10 px-5">
        ...
        <div className="carte mt-4 p-4">
          <p className="text-[15px] leading-relaxed text-texte">
            ...
            vous cherchez une publication validée à l&apos;avance, un texte écrit par vos soins, ou
            la garantie d&apos;un avis positif.
          </p>
        </div>

        <div className="carte mt-3 p-4">
          <p className="text-[15px] leading-relaxed text-texte">
            <strong className="font-semibold text-encre">C&apos;est pour vous si</strong> vous êtes
            convaincu de la qualité de votre lieu et que vous voulez qu&apos;on le voie tel
            qu&apos;il est.
          </p>
        </div>
      </section>
